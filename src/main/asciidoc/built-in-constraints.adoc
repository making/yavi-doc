...
[source,java]
----
Validator<Length> validator = ValidatorBuilder.<Length> of()
        .constraints(Length::value, "length", c -> c.isByte())
        .build();

ConstraintViolations violations = validator.validate(Length.valueOf("127")); // Valid
ConstraintViolations violations = validator.validate(Length.valueOf(null)); // Valid
ConstraintViolations violations = validator.validate(Length.valueOf("a")); // Invalid ("length" must be a valid representation of a byte.)
----
...
----
Validator<Length> validator = ValidatorBuilder.<Length> of()
        .constraints(Length::value, "length", c -> c.isShort())
        .build();

ConstraintViolations violations = validator.validate(Length.valueOf("32767")); // Valid
ConstraintViolations violations = validator.validate(Length.valueOf(null)); // Valid
ConstraintViolations violations = validator.validate(Length.valueOf("a")); // Invalid ("length" must be a valid representation of a short.)
----
...
----
Validator<Length> validator = ValidatorBuilder.<Length> of()
        .constraints(Length::value, "length", c -> c.isInteger())
        .build();

ConstraintViolations violations = validator.validate(Length.valueOf("2147483647")); // Valid
ConstraintViolations violations = validator.validate(Length.valueOf(null)); // Valid
ConstraintViolations violations = validator.validate(Length.valueOf("a")); // Invalid ("length" must be a valid representation of an integer.)
----
...
----
Validator<Length> validator = ValidatorBuilder.<Length> of()
        .constraints(Length::value, "length", c -> c.isLong())
        .build();

ConstraintViolations violations = validator.validate(Length.valueOf("9223372036854775807")); // Valid
ConstraintViolations violations = validator.validate(Length.valueOf(null)); // Valid
ConstraintViolations violations = validator.validate(Length.valueOf("a")); // Invalid ("length" must be a valid representation of a long.)
----
...
----
Validator<Length> validator = ValidatorBuilder.<Length> of()
        .constraints(Length::value, "length", c -> c.isFloat())
        .build();

ConstraintViolations violations = validator.validate(Length.valueOf("0.1")); // Valid
ConstraintViolations violations = validator.validate(Length.valueOf(null)); // Valid
ConstraintViolations violations = validator.validate(Length.valueOf("a")); // Invalid ("length" must be a valid representation of a float.)
----
...
----
Validator<Length> validator = ValidatorBuilder.<Length> of()
        .constraints(Length::value, "length", c -> c.isDouble())
        .build();

ConstraintViolations violations = validator.validate(Length.valueOf("0.1")); // Valid
ConstraintViolations violations = validator.validate(Length.valueOf(null)); // Valid
ConstraintViolations violations = validator.validate(Length.valueOf("a")); // Invalid ("length" must be a valid representation of a double.)
----
...
----
Validator<Length> validator = ValidatorBuilder.<Length> of()
        .constraints(Length::value, "length", c -> c.isBigInteger())
        .build();

ConstraintViolations violations = validator.validate(Length.valueOf("127")); // Valid
ConstraintViolations violations = validator.validate(Length.valueOf(null)); // Valid
ConstraintViolations violations = validator.validate(Length.valueOf("a")); // Invalid ("length" must be a valid representation of a big integer.)
----
