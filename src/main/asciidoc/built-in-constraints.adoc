...
----
Validator<ZipCode> validator = ValidatorBuilder.<ZipCode> of()
        .constraints(ZipCode::getValue, "zipCode", c -> c.pattern("[0-9]{3}-[0-9]{4}"))
        .build();
...
Validator<Password> validator = ValidatorBuilder.<Password>of()
		.constraint(Password::getValue, "password", c -> c.password(policy -> policy
				.uppercase()
				.lowercase()
...
You can define a custom password policy as follows:
