...
----
Validator<UserId> validator = ValidatorBuilder.<UserId> of()
        .constraints(UserId::value, "userId", c -> c.isFloat())
        .build();

ConstraintViolations violations = validator.validate(UserId.valueOf("0.1")); // Valid
ConstraintViolations violations = validator.validate(UserId.valueOf(null)); // Valid
ConstraintViolations violations = validator.validate(UserId.valueOf("a")); // Invalid ("userId" must be a valid representation of a float.)
----
...
----
Validator<UserId> validator = ValidatorBuilder.<UserId> of()
        .constraints(UserId::value, "userId", c -> c.isDouble())
        .build();

ConstraintViolations violations = validator.validate(UserId.valueOf("0.1")); // Valid
ConstraintViolations violations = validator.validate(UserId.valueOf(null)); // Valid
ConstraintViolations violations = validator.validate(UserId.valueOf("a")); // Invalid ("userId" must be a valid representation of a double.)
----
